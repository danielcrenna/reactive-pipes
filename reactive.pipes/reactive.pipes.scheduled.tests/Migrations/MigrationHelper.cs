...
namespace reactive.tests.Scheduled.Migrations
{
    ...
    {
        public static string MigrateToLatest(string databaseType, string connectionString, string profile = null, Assembly assembly = null, bool trace = false, IEnumerable<string> tags = null, bool sqlOnly = false)
        {
            return MigrateToVersion(databaseType, connectionString, 0, profile, assembly, trace, tags, sqlOnly);
        }

        public static string MigrateToVersion(string databaseType, string connectionString, long version, string profile = null, Assembly assembly = null, bool trace = false, IEnumerable<string> tags = null, bool sqlOnly = false)
        {
